...
namespace DiabetesNoteBook.Application.Services
{
    ...
    public class DeleteUserService : IDeleteUserService
    {
        ...
        public async Task DeleteUser(DTODeleteUser delete)
        {
            ...
            var usuarioDB = await _context.Usuarios.Include(x => x.Mediciones).Include(x=>x.UsuarioMedicacions).Include(x=>x.Operaciones).FirstOrDefaultAsync(x => x.Id == delete.Id);
